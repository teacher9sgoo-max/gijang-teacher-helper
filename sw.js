const CACHE_NAME='gijang-teacher-helper-v30';
const APP_SHELL=['./','./index.html','./permissions-settings.js','./manifest.webmanifest','./icons/icon-192.svg','./icons/icon-512.svg'];
